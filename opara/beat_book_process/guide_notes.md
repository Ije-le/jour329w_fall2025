...
The first draft of the guide book I generated had language that I felt would be a tiny bit technical for someone trying to create a beatbook for the first time.
It also seemed quite repetitive: we had part 1, 2, 3 all about the same process, only a little differently.
